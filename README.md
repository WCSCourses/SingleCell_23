...
## 28 July–4 August 2023, INCA, Rio de Janeiro, Brazil
...
- [Notebook 01 - Processing raw scRNA-seq data](https://colab.research.google.com/drive/1muoaXOGi91vFU1jfvLJaiUuynwUcU3BH):
...
- [Notebook 02 - Quality Control, Exploratory Analysis, Data Normalization, and Clustering in scRNA-seq experiments](https://colab.research.google.com/drive/1ucGRUKOg0PUXXZhhZDZBglRik5VfAuHZ):
...
**Related Slides 02:** [Quality control and exploration of scRNA-seq datasets](https://docs.google.com/presentation/d/1QjlSIhJiTGzAWnA9_frSSsrq0J4CfCRss4oWyZbRPz0/edit); **Related Slides 03:** [Normalization, clustering and other concepts](https://docs.google.com/presentation/d/1og64xOAQuRZIbDgWfdaJEFTqhKqxekklLf2VHsKEBk0/edit).

- [Notebook 03 - Differential expression, cell type annotation and functional data analysis](https://colab.research.google.com/drive/1ucGRUKOg0PUXXZhhZDZBglRik5VfAuHZ):
...
**Related Slides 04:** [Differential expression and cell annotation](https://docs.google.com/presentation/d/1vh4cIfAi-SpytoR8Tj34erpfRwbDOu1G0ZVaxQF8rIU/edit).

- [Notebook 04 - Integrating single-cell transcriptomes from multiple samples](https://colab.research.google.com/drive/1LP7ulULxmDrL72tCbVJ7HerMMjBOxprA):
...
- [Notebook 05 - Trajectory inference and pseudotemporal ordering](https://colab.research.google.com/drive/1hAPYW_vUwvKN2ocqksVzYtTyBpdkHP17):
...
- [Notebook 06 - Deciphering cell-cell communication in single-cell transcriptomics data](https://colab.research.google.com/drive/1LvCMvDp9U9231Tt2aDvrqFwSf2tbEBH5):
